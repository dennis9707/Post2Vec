...
from model.model import DistillBertForMultiLable
...
def train(input_train, input_valid, mlb, args):
    ...
    checkpoint_path = './results/checkpoint/current_checkpoint_distillbert_ts1000.pt'
    best_model_path = './results/best_model/best_model_distillbert_ts1000.pt'
    ...
    model = DistillBertForMultiLable(170)
