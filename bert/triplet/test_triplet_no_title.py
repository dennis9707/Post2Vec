...
from model.model import TBertT,TBertSI, TBertTNoTitle
...
def main():
    ...
    if args.model_type == "triplet":
        model = TBertTNoTitle(BertConfig(), args.code_bert, num_class)
    ...
    with open('./logs/no-title-result.csv', 'w', newline='') as output_file:
