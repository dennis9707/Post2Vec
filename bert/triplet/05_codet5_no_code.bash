CUDA_VISIBLE_DEVICES=6,7 python -m torch.distributed.launch \
    ...
    --model_path ../../data/results/Salesforce/codet5-base_01-16-08-48-16_code/final-epoch-0/t_bert.pt \
    --remove_component code \
    --fp16 \
    --fp16_opt_level O2 \
    --learning_rate 1e-5  2>&1| tee ./train_logs/train_codet5_no_code0916.log
